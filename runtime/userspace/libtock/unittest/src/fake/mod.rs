//! `fake` contains fake implementations of Tock kernel components.
//!
//! Fake components emulate the behavior of the real Tock kernel components, but
//! in the unit test environment. They generally have additional testing
//! features, such as error injection functionality.
//!
