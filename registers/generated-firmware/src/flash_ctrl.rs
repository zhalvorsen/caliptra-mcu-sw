...
//
pub const FLASH_CTRL_ADDR: u32 = 0x2000_8000;
pub mod bits {
...
pub mod regs {
    ...
    register_structs! {
        pub FlashCtrl {
            (0x0 => pub fl_interrupt_state: tock_registers::registers::ReadWrite<u32, crate::flash_ctrl::bits::FlInterruptState::Register>),
            (0x4 => pub fl_interrupt_enable: tock_registers::registers::ReadWrite<u32, crate::flash_ctrl::bits::FlInterruptEnable::Register>),
            ...
            (0x14 => pub fl_control: tock_registers::registers::ReadWrite<u32, crate::flash_ctrl::bits::FlControl::Register>),
