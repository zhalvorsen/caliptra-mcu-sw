...
pub mod regs {
    ...
    register_structs! {
        pub OtpCtrl {
            ...
            (0x44 => pub dai_wdata_rf_direct_access_wdata_0: tock_registers::registers::ReadOnly<u32>),
            (0x48 => pub dai_wdata_rf_direct_access_wdata_1: tock_registers::registers::ReadOnly<u32>),
