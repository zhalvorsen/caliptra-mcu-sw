...
pub mod regs {
    ...
    register_structs! {
        pub RecoveryFlashCtrl {
            (0x0 => pub fl_interrupt_state: tock_registers::registers::ReadWrite<u32, crate::recovery_flash_ctrl::bits::FlInterruptState::Register>),
            (0x4 => pub fl_interrupt_enable: tock_registers::registers::ReadWrite<u32, crate::recovery_flash_ctrl::bits::FlInterruptEnable::Register>),
            ...
            (0x14 => pub fl_control: tock_registers::registers::ReadWrite<u32, crate::recovery_flash_ctrl::bits::FlControl::Register>),
            (0x18 => pub op_status: tock_registers::registers::ReadWrite<u32, crate::recovery_flash_ctrl::bits::OpStatus::Register>),
            (0x1c => pub ctrl_regwen: tock_registers::registers::ReadOnly<u32, crate::recovery_flash_ctrl::bits::CtrlRegwen::Register>),
            (0x20 => @END),
        }
    }
}
