...
pub mod regs {
    ...
    register_structs! {
        pub Soc {
            ...
            (0x5c => pub cptra_mbox_axi_id_lock: [tock_registers::registers::ReadWrite<u32, crate::soc::bits::CptraXxxxAxiIdLock::Register>; 5]),
            (0x70 => pub cptra_trng_valid_axi_id: tock_registers::registers::ReadWrite<u32>),
            (0x74 => pub cptra_trng_axi_id_lock: tock_registers::registers::ReadWrite<u32, crate::soc::bits::CptraXxxxAxiIdLock::Register>),
            ...
            (0x10c => pub cptra_fuse_axi_id_lock: tock_registers::registers::ReadWrite<u32, crate::soc::bits::CptraXxxxAxiIdLock::Register>),
            ...
            (0x280 => pub fuse_key_manifest_pk_hash_mask: tock_registers::registers::ReadWrite<u32, crate::soc::bits::FuseKeyManifestPkHashMask::Register>),
            ...
            (0x33c => pub fuse_life_cycle: tock_registers::registers::ReadWrite<u32, crate::soc::bits::FuseLifeCycle::Register>),
            (0x340 => pub fuse_lms_verify: tock_registers::registers::ReadWrite<u32, crate::soc::bits::FuseLmsVerify::Register>),
