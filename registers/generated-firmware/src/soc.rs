    ...
    register_bitfields! {
        u32,
            ...
            pub CptraHwConfig [
                ...
                ActiveModeEn OFFSET(5) NUMBITS(1) [],
            ],
...
pub mod regs {
    ...
    register_structs! {
        pub Soc {
            ...
            (0x260 => pub fuse_key_manifest_pk_hash: [tock_registers::registers::ReadWrite<u32>; 12]),
            (0x290 => pub fuse_key_manifest_pk_hash_mask: [tock_registers::registers::ReadWrite<u32>; 8]),
            (0x2b0 => _reserved2),
