...
pub mod regs {
    ...
    register_structs! {
        pub I3c {
            ...
            (0x8c => pub piocontrol_ibi_port: tock_registers::registers::ReadOnly<u32, crate::i3c::bits::IbiPort::Register>),
            ...
            (0x104 => pub sec_fw_recovery_if_prot_cap_0: tock_registers::registers::ReadWrite<u32>),
            (0x108 => pub sec_fw_recovery_if_prot_cap_1: tock_registers::registers::ReadWrite<u32>),
            (0x10c => pub sec_fw_recovery_if_prot_cap_2: tock_registers::registers::ReadWrite<u32>),
            (0x110 => pub sec_fw_recovery_if_prot_cap_3: tock_registers::registers::ReadWrite<u32>),
            (0x114 => pub sec_fw_recovery_if_device_id_0: tock_registers::registers::ReadWrite<u32>),
            ...
            (0x12c => pub sec_fw_recovery_if_device_id_6: tock_registers::registers::ReadWrite<u32>),
            (0x130 => pub sec_fw_recovery_if_device_status_0: tock_registers::registers::ReadWrite<u32>),
            (0x134 => pub sec_fw_recovery_if_device_status_1: tock_registers::registers::ReadWrite<u32>),
            (0x138 => pub sec_fw_recovery_if_device_reset: tock_registers::registers::ReadWrite<u32>),
            (0x13c => pub sec_fw_recovery_if_recovery_ctrl: tock_registers::registers::ReadWrite<u32>),
            (0x140 => pub sec_fw_recovery_if_recovery_status: tock_registers::registers::ReadWrite<u32>),
            (0x144 => pub sec_fw_recovery_if_hw_status: tock_registers::registers::ReadWrite<u32>),
            (0x148 => pub sec_fw_recovery_if_indirect_fifo_ctrl_0: tock_registers::registers::ReadWrite<u32>),
            (0x14c => pub sec_fw_recovery_if_indirect_fifo_ctrl_1: tock_registers::registers::ReadWrite<u32>),
            (0x150 => pub sec_fw_recovery_if_indirect_fifo_status_0: tock_registers::registers::ReadWrite<u32>),
            (0x154 => pub sec_fw_recovery_if_indirect_fifo_status_1: tock_registers::registers::ReadWrite<u32>),
            (0x158 => pub sec_fw_recovery_if_indirect_fifo_status_2: tock_registers::registers::ReadWrite<u32>),
            (0x15c => pub sec_fw_recovery_if_indirect_fifo_status_3: tock_registers::registers::ReadWrite<u32>),
            (0x160 => pub sec_fw_recovery_if_indirect_fifo_status_4: tock_registers::registers::ReadWrite<u32>),
            (0x164 => pub sec_fw_recovery_if_indirect_fifo_status_5: tock_registers::registers::ReadWrite<u32>),
            ...
            (0x1b8 => pub stdby_ctrl_mode_rsvd_2: tock_registers::registers::ReadWrite<u32>),
            ...
            (0x1c4 => pub tti_control: tock_registers::registers::ReadWrite<u32>),
            (0x1c8 => pub tti_status: tock_registers::registers::ReadWrite<u32>),
