...
pub mod regs {
    ...
    register_structs! {
        pub I3c {
            ...
            (0x4 => pub hc_control: tock_registers::registers::ReadWrite<u32, crate::i3c::bits::HcControl::Register>),
            (0x8 => pub controller_device_addr: tock_registers::registers::ReadWrite<u32, crate::i3c::bits::ControllerDeviceAddr::Register>),
            (0xc => pub hc_capabilities: tock_registers::registers::ReadOnly<u32, crate::i3c::bits::HcCapabilities::Register>),
            (0x10 => pub reset_control: tock_registers::registers::ReadWrite<u32, crate::i3c::bits::ResetControl::Register>),
            (0x14 => pub present_state: tock_registers::registers::ReadOnly<u32, crate::i3c::bits::PresentState::Register>),
            (0x18 => _reserved0),
            (0x20 => pub intr_status: tock_registers::registers::ReadWrite<u32, crate::i3c::bits::IntrStatus::Register>),
            (0x24 => pub intr_status_enable: tock_registers::registers::ReadWrite<u32, crate::i3c::bits::IntrStatusEnable::Register>),
            (0x28 => pub intr_signal_enable: tock_registers::registers::ReadWrite<u32, crate::i3c::bits::IntrSignalEnable::Register>),
            (0x2c => pub intr_force: tock_registers::registers::WriteOnly<u32, crate::i3c::bits::IntrForce::Register>),
            (0x30 => pub dat_section_offset: tock_registers::registers::ReadOnly<u32, crate::i3c::bits::DatSectionOffset::Register>),
            (0x34 => pub dct_section_offset: tock_registers::registers::ReadWrite<u32, crate::i3c::bits::DctSectionOffset::Register>),
            (0x38 => pub ring_headers_section_offset: tock_registers::registers::ReadOnly<u32, crate::i3c::bits::RingHeadersSectionOffset::Register>),
            (0x3c => pub pio_section_offset: tock_registers::registers::ReadOnly<u32, crate::i3c::bits::PioSectionOffset::Register>),
            (0x40 => pub ext_caps_section_offset: tock_registers::registers::ReadOnly<u32, crate::i3c::bits::ExtCapsSectionOffset::Register>),
            (0x44 => _reserved1),
            (0x4c => pub int_ctrl_cmds_en: tock_registers::registers::ReadOnly<u32, crate::i3c::bits::IntCtrlCmdsEn::Register>),
            (0x50 => _reserved2),
            (0x58 => pub ibi_notify_ctrl: tock_registers::registers::ReadWrite<u32, crate::i3c::bits::IbiNotifyCtrl::Register>),
            (0x5c => pub ibi_data_abort_ctrl: tock_registers::registers::ReadWrite<u32, crate::i3c::bits::IbiDataAbortCtrl::Register>),
            (0x60 => pub dev_ctx_base_lo: tock_registers::registers::ReadWrite<u32, crate::i3c::bits::DevCtxBaseLo::Register>),
            (0x64 => pub dev_ctx_base_hi: tock_registers::registers::ReadWrite<u32, crate::i3c::bits::DevCtxBaseHi::Register>),
            (0x68 => pub dev_ctx_sg: tock_registers::registers::ReadOnly<u32, crate::i3c::bits::DevCtxSg::Register>),
            (0x6c => _reserved3),
            ...
            (0x8c => pub ibi_port: tock_registers::registers::ReadOnly<u32, crate::i3c::bits::IbiPort::Register>),
            (0x90 => pub queue_thld_ctrl: tock_registers::registers::ReadWrite<u32, crate::i3c::bits::QueueThldCtrl::Register>),
            (0x94 => pub data_buffer_thld_ctrl: tock_registers::registers::ReadWrite<u32, crate::i3c::bits::DataBufferThldCtrl::Register>),
            (0x98 => pub queue_size: tock_registers::registers::ReadOnly<u32, crate::i3c::bits::QueueSize::Register>),
            (0x9c => pub alt_queue_size: tock_registers::registers::ReadOnly<u32, crate::i3c::bits::AltQueueSize::Register>),
            (0xa0 => pub pio_intr_status: tock_registers::registers::ReadWrite<u32, crate::i3c::bits::PioIntrStatus::Register>),
            (0xa4 => pub pio_intr_status_enable: tock_registers::registers::ReadWrite<u32, crate::i3c::bits::PioIntrStatusEnable::Register>),
            (0xa8 => pub pio_intr_signal_enable: tock_registers::registers::ReadWrite<u32, crate::i3c::bits::PioIntrSignalEnable::Register>),
            (0xac => pub pio_intr_force: tock_registers::registers::WriteOnly<u32, crate::i3c::bits::PioIntrForce::Register>),
            (0xb0 => pub pio_control: tock_registers::registers::ReadWrite<u32, crate::i3c::bits::PioControl::Register>),
            (0xb4 => _reserved4),
            (0x100 => pub termination_extcap_header: tock_registers::registers::ReadOnly<u32, crate::i3c::bits::ExtcapHeader::Register>),
            ...
            (0x16c => _reserved5),
            (0x180 => pub extcap_header0: tock_registers::registers::ReadOnly<u32, crate::i3c::bits::ExtcapHeader::Register>),
            (0x184 => pub stby_cr_control: tock_registers::registers::ReadWrite<u32, crate::i3c::bits::StbyCrControl::Register>),
            (0x188 => pub stby_cr_device_addr: tock_registers::registers::ReadWrite<u32, crate::i3c::bits::StbyCrDeviceAddr::Register>),
            (0x18c => pub stby_cr_capabilities: tock_registers::registers::ReadWrite<u32, crate::i3c::bits::StbyCrCapabilities::Register>),
            (0x190 => pub _rsvd_0: tock_registers::registers::ReadWrite<u32>),
            (0x194 => pub stby_cr_status: tock_registers::registers::ReadWrite<u32, crate::i3c::bits::StbyCrStatus::Register>),
            (0x198 => pub stby_cr_device_char: tock_registers::registers::ReadWrite<u32, crate::i3c::bits::StbyCrDeviceChar::Register>),
            (0x19c => pub stby_cr_device_pid_lo: tock_registers::registers::ReadWrite<u32>),
            (0x1a0 => pub stby_cr_intr_status: tock_registers::registers::ReadWrite<u32, crate::i3c::bits::StbyCrIntrStatus::Register>),
            (0x1a4 => pub _rsvd_1: tock_registers::registers::ReadWrite<u32>),
            (0x1a8 => pub stby_cr_intr_signal_enable: tock_registers::registers::ReadWrite<u32, crate::i3c::bits::StbyCrIntrSignalEnable::Register>),
            (0x1ac => pub stby_cr_intr_force: tock_registers::registers::ReadWrite<u32, crate::i3c::bits::StbyCrIntrForce::Register>),
            (0x1b0 => pub stby_cr_ccc_config_getcaps: tock_registers::registers::ReadWrite<u32, crate::i3c::bits::StbyCrCccConfigGetcaps::Register>),
            (0x1b4 => pub stby_cr_ccc_config_rstact_params: tock_registers::registers::ReadWrite<u32, crate::i3c::bits::StbyCrCccConfigRstactParams::Register>),
            (0x1b8 => pub _rsvd_2: tock_registers::registers::ReadWrite<u32>),
            (0x1bc => pub _rsvd_3: tock_registers::registers::ReadWrite<u32>),
            (0x1c0 => pub extcap_header1: tock_registers::registers::ReadOnly<u32, crate::i3c::bits::ExtcapHeader::Register>),
            (0x1c4 => pub control: tock_registers::registers::ReadWrite<u32>),
            (0x1c8 => pub status: tock_registers::registers::ReadWrite<u32>),
            (0x1cc => pub tti_reset_control: tock_registers::registers::ReadWrite<u32, crate::i3c::bits::TtiResetControl::Register>),
            (0x1d0 => pub interrupt_status: tock_registers::registers::ReadWrite<u32, crate::i3c::bits::InterruptStatus::Register>),
            (0x1d4 => pub interrupt_enable: tock_registers::registers::ReadWrite<u32, crate::i3c::bits::InterruptEnable::Register>),
            (0x1d8 => pub interrupt_force: tock_registers::registers::ReadWrite<u32, crate::i3c::bits::InterruptForce::Register>),
            ...
            (0x1f0 => pub tti_queue_size: tock_registers::registers::ReadOnly<u32, crate::i3c::bits::TtiQueueSize::Register>),
            (0x1f4 => pub ibi_tti_queue_size: tock_registers::registers::ReadOnly<u32, crate::i3c::bits::IbiTtiQueueSize::Register>),
            (0x1f8 => pub tti_queue_thld_ctrl: tock_registers::registers::ReadWrite<u32, crate::i3c::bits::TtiQueueThldCtrl::Register>),
            (0x1fc => pub tti_data_buffer_thld_ctrl: tock_registers::registers::ReadWrite<u32, crate::i3c::bits::TtiDataBufferThldCtrl::Register>),
            (0x200 => pub extcap_header2: tock_registers::registers::ReadOnly<u32, crate::i3c::bits::ExtcapHeader::Register>),
            ...
            (0x21c => pub soc_pad_conf: tock_registers::registers::ReadWrite<u32, crate::i3c::bits::SocPadConf::Register>),
            (0x220 => pub soc_pad_attr: tock_registers::registers::ReadWrite<u32, crate::i3c::bits::SocPadAttr::Register>),
            ...
            (0x22c => pub t_r_reg: tock_registers::registers::ReadWrite<u32, crate::i3c::bits::TRReg::Register>),
            (0x230 => pub t_f_reg: tock_registers::registers::ReadWrite<u32, crate::i3c::bits::TFReg::Register>),
            (0x234 => pub t_su_dat_reg: tock_registers::registers::ReadWrite<u32, crate::i3c::bits::TSuDatReg::Register>),
            (0x238 => pub t_hd_dat_reg: tock_registers::registers::ReadWrite<u32, crate::i3c::bits::THdDatReg::Register>),
            (0x23c => pub t_high_reg: tock_registers::registers::ReadWrite<u32, crate::i3c::bits::THighReg::Register>),
            (0x240 => pub t_low_reg: tock_registers::registers::ReadWrite<u32, crate::i3c::bits::TLowReg::Register>),
            (0x244 => pub t_hd_sta_reg: tock_registers::registers::ReadWrite<u32, crate::i3c::bits::THdStaReg::Register>),
            (0x248 => pub t_su_sta_reg: tock_registers::registers::ReadWrite<u32, crate::i3c::bits::TSuStaReg::Register>),
            (0x24c => pub t_su_sto_reg: tock_registers::registers::ReadWrite<u32, crate::i3c::bits::TSuStoReg::Register>),
            ...
            (0x25c => _reserved6),
            (0x260 => pub extcap_header3: tock_registers::registers::ReadOnly<u32, crate::i3c::bits::ExtcapHeader::Register>),
            (0x264 => pub controller_config: tock_registers::registers::ReadOnly<u32, crate::i3c::bits::ControllerConfig::Register>),
            (0x268 => _reserved7),
