...
impl emulator_bus::Bus for SocBus {
    fn read(
        ...
        match addr {
            ...
            0x35c..0x360 => Ok(caliptra_emu_types::RvData::from(
                self.periph.read_fuse_pqc_key_type().reg.get(),
            )),
            0x360..0x370 => Ok(self.periph.read_fuse_soc_manifest_svn()),
            0x370..0x374 => Ok(caliptra_emu_types::RvData::from(
    ...
    fn write(
        ...
        match addr {
            ...
            0x290..0x294 => {
                self.periph
                    .write_fuse_ecc_revocation(emulator_bus::ReadWriteRegister::new(val));
                Ok(())
            }
            0x2b4..0x2b8 => {
            ...
            0x35c..0x360 => {
                self.periph
                    .write_fuse_pqc_key_type(emulator_bus::ReadWriteRegister::new(val));
                Ok(())
            }
            0x360..0x370 => {
            ...
            0x370..0x374 => {
                self.periph
                    .write_fuse_soc_manifest_max_svn(emulator_bus::ReadWriteRegister::new(val));
                Ok(())
            }
            0x500..0x504 => {
