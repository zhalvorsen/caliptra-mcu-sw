...
pub trait I3cPeripheral {
    ...
    fn read_i3c_ec_sec_fw_recovery_if_indirect_fifo_ctrl_1(
        ...
        u32,
        registers_generated::i3c::bits::IndirectFifoCtrl1::Register,
    > {
        emulator_bus::ReadWriteRegister::new(0)
    }
...
impl emulator_bus::Bus for I3cBus {
    fn read(
        ...
        match addr {
            ...
            0x14c..0x150 => Ok(caliptra_emu_types::RvData::from(
                self.periph
    ...
    fn write(
        ...
        match addr {
            ...
            0x14c..0x150 => {
                self.periph
                    .write_i3c_ec_sec_fw_recovery_if_indirect_fifo_ctrl_1(
                        emulator_bus::ReadWriteRegister::new(val),
                    );
                Ok(())
            }
