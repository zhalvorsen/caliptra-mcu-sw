...
impl caliptra_emu_bus::Bus for MciBus {
    fn read(
        ...
        match addr {
            ...
            0x20..0x24 => Ok(self.periph.read_mci_reg_fw_flow_status()),
            ...
            0x50..0x54 => Ok(self.periph.read_mci_reg_fw_error_fatal()),
            ...
            0x90..0x94 => Ok(self.periph.read_mci_reg_internal_fw_error_fatal_mask()),
            0x94..0x98 => Ok(self.periph.read_mci_reg_internal_fw_error_non_fatal_mask()),
            ...
            0x414..0x418 => Ok(caliptra_emu_types::RvData::from(
                self.periph.read_mci_reg_debug_out().reg.get(),
            )),
