...
impl emulator_bus::Bus for AutoRootBus {
    fn read(
        ...
        let result = match addr {
            ...
            0x3000_0000..=0x3000_0023 => {
                if let Some(periph) = self.dma_periph.as_mut() {
                    periph.read(size, addr - 0x3000_0000)
                } else {
                    Err(emulator_bus::BusError::LoadAccessFault)
                }
            }
            0x3002_0000..=0x3002_0027 => {
            ...
            0x7000_0400..=0x7000_048b => {
                if let Some(periph) = self.lc_periph.as_mut() {
                    periph.read(size, addr - 0x7000_0400)
                } else {
                    Err(emulator_bus::BusError::LoadAccessFault)
                }
            }
    ...
    fn write(
        ...
        let result = match addr {
            ...
            0x3000_0000..=0x3000_0023 => {
                if let Some(periph) = self.dma_periph.as_mut() {
                    periph.write(size, addr - 0x3000_0000, val)
                } else {
                    Err(emulator_bus::BusError::StoreAccessFault)
                }
            }
            ...
            0x7000_0400..=0x7000_048b => {
                if let Some(periph) = self.lc_periph.as_mut() {
                    periph.write(size, addr - 0x7000_0400, val)
                } else {
                    Err(emulator_bus::BusError::StoreAccessFault)
                }
            }
